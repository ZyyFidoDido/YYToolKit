...
+ (void)getNetworkRequestWithUrlString:(NSString *)urlString parameters:(id)parameters isCache:(BOOL)isCache completion:(requestCompletion)completion{
    ...
    [self requestType:NetworkRequestTypeGET url:urlString parameters:parameters isCache:isCache cacheTime:0.0 completion:completion];
}
...
+ (void)getCacheRequestWithUrlString:(NSString *)urlString parameters:(id)parameters cacheTime:(float)time completion:(requestCompletion)completion{
    ...
    [self requestType:NetworkRequestTypeGET url:urlString parameters:parameters isCache:YES cacheTime:time completion:completion];
}
...
+ (void)postNetworkRequestWithUrlString:(NSString *)urlString parameters:(id)parameters isCache:(BOOL)isCache completion:(requestCompletion)completion{
    ...
    [self requestType:NetworkRequestTypePOST url:urlString parameters:parameters isCache:isCache cacheTime:0.0 completion:completion];
}
...
+ (void)postCacheRequestWithUrlString:(NSString *)urlString parameters:(id)parameters cacheTime:(float)time completion:(requestCompletion)completion{
    ...
    [self requestType:NetworkRequestTypePOST url:urlString parameters:parameters isCache:YES cacheTime:time completion:completion];
}

//Zyy
#pragma mark -- POST请求 <application/json上传> --
+ (void)postJsonRequestWithUrlString:(NSString *)urlString parameters:(id)parameters isCache:(BOOL)isCache completion:(requestCompletion)completion {
    [self requestJsonUrl:urlString parameters:parameters isCache:isCache cacheTime:0.0 completion:completion];
}

#pragma mark -- POST请求 <application/json上传> <含缓存时间> --
+ (void)postJsonRequestWithUrlString:(NSString *)urlString parameters:(id)parameters cacheTime:(float)time completion:(requestCompletion)completion {
    [self requestJsonUrl:urlString parameters:parameters isCache:YES cacheTime:time completion:completion];
}

//单独为json上传param 独立出来的
+ (void)requestJsonUrl:(NSString *)urlString parameters:(id)parameters isCache:(BOOL)isCache cacheTime:(float)time completion:(requestCompletion)completion {
...
//                completion(1,dict);
    ...
    [manager POST:urlString parameters:parameters progress:^(NSProgress * _Nonnull uploadProgress) {
        ...
        if (isCache) {
            ...
            [self cacheResponseObject:[self DataTOjsonString:responseObject] urlString:urlString parameters:parameters];
        }
 ...
 *  @param time       缓存时间
 */
+ (void)requestType:(NetworkRequestType)type url:(NSString *)urlString parameters:(id)parameters isCache:(BOOL)isCache cacheTime:(float)time completion:(requestCompletion)completion{
