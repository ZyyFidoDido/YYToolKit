...
//  YTSellingCC
//
//  Created by Yitian on 2018/12/11.
...
#define YTVsersion      [[UIDevice currentDevice] systemVersion] //系统版本
#define DesionV         [NSString yy_iphoneType] //手机型号



#define MyFormatting(value) YY_String(value)

#define VersionBuild [[[NSBundle mainBundle] infoDictionary] objectForKey:@"CFBundleShortVersionString"]
#define curSimeStamp  [NSString stringWithFormat:@"%ld", (long)[[NSDate  date] timeIntervalSince1970]]



#define GETMAXY(y) CGRectGetMaxY(y)
#define GETMAXX(x) CGRectGetMaxX(x)
