//
//  NSString+YyShortLink.m
//  YTSellingCC
//
//  Created by Yitian on 2019/1/23.
//  Copyright © 2019 YiTian. All rights reserved.
//

#import "NSString+YyShortLink.h"
#import <CommonCrypto/CommonDigest.h>

@implementation NSString (YyShortLink)
...
{
    NSArray *chars = [[NSArray alloc] initWithObjects:
                      @"a" , @"b" , @"c" , @"d" , @"e" , @"f" , @"g" , @"h" ,
